...
```bash
composer require pacoorozco/laravel-form-components
```
...
<img src="https://github.com/pacoorozco/laravel-form-components/blob/master/quick-example-form.png?raw=true" width="450"  alt="Quick example form"/>
...
If you discover any security related issues, please email pakus@pakusland.net instead of using the issue tracker.

## Credits

- [Pascal Baljet](https://github.com/pascalbaljet) - The original author and maintainer
