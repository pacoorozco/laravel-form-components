...
namespace PacoOrozco\LaravelFormComponents\Support;
...
class ServiceProvider extends BaseServiceProvider
{
    ...
    public function boot()
    {
        ...
        Blade::directive('bind', function ($bind) {
            return '<?php app(\PacoOrozco\LaravelFormComponents\FormDataBinder::class)->bind(' . $bind . '); ?>';
        });

        Blade::directive('endbind', function () {
            return '<?php app(\PacoOrozco\LaravelFormComponents\FormDataBinder::class)->pop(); ?>';
        });

        Blade::directive('wire', function ($modifier) {
            return '<?php app(\PacoOrozco\LaravelFormComponents\FormDataBinder::class)->wire(' . $modifier . '); ?>';
        });

        Blade::directive('endwire', function () {
            return '<?php app(\PacoOrozco\LaravelFormComponents\FormDataBinder::class)->endWire(); ?>';
        });
