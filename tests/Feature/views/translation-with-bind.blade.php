@php
    $targetA = new \PacoOrozco\LaravelFormComponents\Tests\Feature\TranslatableModel;
    $targetA->setTranslations('input', ['nl' => 'hallo', 'en' => 'hello']);

    $targetB = new \PacoOrozco\LaravelFormComponents\Tests\Feature\TranslatableModel;
